...
My research focuses on improving the generalizability, eXplainability and robustness of AI models for ubiquitous sensing. I develop novel frameworks and training strategies to enhance model performance, interpretability, fairness, privacy, and resilience under domain shift, data scarcity, and real-world variability. My work spans application areas such as wearable sensing, computer vision, natural language processing, and audio processing.
